...
public class COkHttpUDUtils {
    ...
    public static COkHttpUDUtils post(){
        if (okHttpClient==null){
            throw new NullPointerException("Ct7OkHttp没有初始化: new COkHttpUtils().init()");
        }
        POST_TYPE = POST_FILE_LIST;
        return new COkHttpUDUtils();
    }

    public static COkHttpUDUtils post(@NonNull File file){
        if (okHttpClient==null){
            throw new NullPointerException("Ct7OkHttp没有初始化: new COkHttpUtils().init()");
        }
        post_file = file;
    ...
    public COkHttpUDUtils url(@NonNull String string){
        this.url = string;
        return this;
    }

    public COkHttpUDUtils header(String key, String value){
        if (headers == null){
    ...
    public COkHttpUDUtils param(String key, String value){
        if (params == null){
    ...
    public COkHttpUDUtils file(String key, String value, File file){
        if (files == null){
            files = new ArrayList<>();
        }
    ...
    public COkHttpUDUtils execute(final OnResponse onResponse){
